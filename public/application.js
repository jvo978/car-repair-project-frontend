...
var showCar = function showCar(carID) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/cars/' + carID,
    headers: {
...
$(function () {
  ...
  // })
  $('.clear-forms').on('click', events.resetForms);
...
var onUpdateCar = function onUpdateCar(event) {
  ...
  api.updateCar(data).then(ui.updateCarSuccess).then(function () {
    return onShowCars(event);
...
var onShowCars = function onShowCars(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.showCars(data).then(ui.showCarsSuccess).catch(ui.showCarsFailure);
};

var onCreateCar = function onCreateCar(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createCar(data).then(ui.createCarSuccess).then(function () {
    return onShowCars(event);
...
var showCarSuccess = function showCarSuccess(response) {
...
var updateCarSuccess = function updateCarSuccess(response) {
...
var updateCarFailure = function updateCarFailure(response) {
  $('#status-message').html('Unable to update car');
};

var onShowCar = function onShowCar(event) {
  event.preventDefault();
  var carID = event.target.id;
  api.showCar(carID).then(showCarSuccess).catch(showCarFailure);
};

var onDeleteCar = function onDeleteCar(event) {
  event.preventDefault();
  var carID = event.target.id;
  api.deleteCar(carID).then(deleteCarSuccess(carID)).catch(deleteCarFailure);
};

var showCarFailure = function showCarFailure(response) {
  $('#status-message').html('Unable to update car');
};

var showCarsFailure = function showCarsFailure(response) {
  $('#status-message').html('Could not show cars');
};

var createCarFailure = function createCarFailure(response) {
  $('#status-message').html('Car successfully added');
};
...
var deleteCarSuccess = function deleteCarSuccess(carID) {
  $('#status-message').html('Car successfully deleted');
  $('#car-' + carID).remove();
};

var deleteCarFailure = function deleteCarFailure() {
...
module.exports = __webpack_require__.p + "4dc9522db20a438773ec73419e31c3ee.jpg";
